...
function CopyIndexDialogCtrl(a, b, c, d) {
    var e = a.uploader = new c({url: "/index/settings"});
    e.onSuccessItem = function (b, c, d, e) {
        console.info("onSuccessItem", b, c, d, e);
        var f = /^settings\.json.*/, g = /(\w+)-mapping\.json.*/, h = f.exec(c), i = g.exec(c);
        h ? a.copyTo.settings = c : i ? (a.copyTo.mappings || (a.copyTo.mappings = {}), a.copyTo.mappings[i[1]] = i[0]) : console.log("Unrecognized file type, require ...."), console.log(a.copyTo)
    }, e.onErrorItem = function (a, b, c, d) {
        console.info("onErrorItem", a, b, c, d)
    }, e.onCancelItem = function (a, b, c, d) {
        console.info("onCancelItem", a, b, c, d)
    }, a.index = d, a.copyTo = {copyFrom: d.name}, a.close = function (c) {
        b.close(a.copyTo)
    }
}
function CreateNewIndexDialogCtrl(a, b, c) {
    var d = a.uploader = new c({url: "/index/settings"});
    d.onSuccessItem = function (b, c, d, e) {
        console.info("onSuccessItem", b, c, d, e);
        var f = /^settings\.json.*/, g = /(\w+)-mapping\.json.*/, h = f.exec(c), i = g.exec(c);
        h ? a.copyTo.settings = c : i ? (a.copyTo.mappings || (a.copyTo.mappings = {}), a.copyTo.mappings[i[1]] = i[0]) : console.log("Unrecognized file type, require ...."), console.log(a.copyTo)
        ...
        console.info("onCancelItem", a, b, c, d)
    }, a.copyTo = {}, a.close = function (c) {
        b.close(a.copyTo)
    }
}
function CreateSnapshotCtrl(a, b) {
    a.dialog = {includeGlobalState: !0, ignoreUnavailable: !1}, a.close = function (a) {
        b.close(a)
    }
}
function CreateSnapshotRepositoryCtrl(a, b) {
    a.dialog = {type: "fs"}, a.close = function (a) {
        b.close(a)
    }
}
function DashboardCtrl(a) {
}
function DeleteIndexesDialogCtrl(a, b) {
    a.close = function () {
        b.close(a.indexes)
    }
}
function EditIndexDialogCtrl(a, b, c) {
    a.index = c, a.changedIndex = {numReplicas: c.numberOfReplicas}, a.close = function (c) {
        b.close(a.changedIndex)
    }
}
function IndexCtrl(a, b, c, d) {
    function e(a) {
        d.$broadcast("msg:notification", "success", a)
    }

    a.indexes = [], a.initIndexes = function () {
        c.loadIndices(function (b) {
            a.indexes = b
        })
    }, a.editIndexDialog = function (a) {
        var d = {
            backdrop: !0,
            keyboard: !0,
            backdropClick: !0,
        ...
        f.result.then(function (b) {
            if (b) {
                var d = {name: a.name, numReplicas: b.numReplicas};
                c.changeIndex(d, function () {
                    a.numberOfReplicas = b.numReplicas, e("Changed number of replicas for index " + a.name)
                })
            }
        }, function () {
        })
    }, a.deleteIndex = function (b) {
        c.deleteIndex(b.name, function () {
            var c = a.indexes.indexOf(b);
            a.indexes.splice(c, 1), e("Deleted the index " + b.name)
        })
    }, a.openDeleteIndexesDialog = function (d) {
        var f = {
            backdrop: !0,
            keyboard: !0,
            backdropClick: !0,
        ...
        g.result.then(function (b) {
            b && c.deleteIndex(b, function () {
                e("Deleted the indexes " + b), a.initIndexes()
            })
        }, function () {
        })
    }, a.closeIndex = function (a) {
        c.closeIndex(a.name, function () {
            a.state = "CLOSED", e("Closed the index " + a.name)
        })
    }, a.openIndex = function (b) {
        c.openIndex(b.name, function () {
            a.initIndexes(), e("Opened the index " + b.name)
        })
    }, a.optimizeIndexDialog = function (d) {
        var f = {
            backdrop: !0,
            keyboard: !0,
            backdropClick: !0,
        ...
        g.result.then(function (b) {
            b && c.optimizeIndex(d.name, b.maxSegments, function () {
                a.initIndexes(), e("Started optimizing the index " + d.name + ". Use refresh to monitor progress")
            })
        }, function () {
        })
    }, a.copyIndexDialog = function (d) {
        var f = {
            backdrop: !0,
            keyboard: !0,
            backdropClick: !0,
        ...
        g.result.then(function (b) {
            b && c.copyIndex(b, function () {
                a.initIndexes(), e("Copied into the index " + d.name)
            })
        }, function () {
        })
    }, a.createNewIndexDialog = function () {
        var d = {
            backdrop: !0,
            keyboard: !0,
            backdropClick: !0,
        ...
        f.result.then(function (b) {
            b && c.copyIndex(b, function () {
                a.initIndexes(), e("Created the index " + b.name)
            })
        }, function () {
        })
    }, a.createAlias = function (b) {
        c.createAlias(b.name, function () {
            a.initIndexes(), e("Created alias for the index " + b.name)
        })
    }
}
function NavbarCtrl(a, b, c) {
    function d() {
        b.get("/cluster/status").success(function (b) {
            a.clusterStatus = b
        }).error(function (b) {
            a.clusterStatus = {name: "unknown", status: "red"}
        })
    }
    ...
    }, this.selectByUrl = function (b) {
        angular.forEach(e, function (c) {
            c.link == b.split("/")[1] && a.select(c)
        })
    }, this.init = function () {
        d(), c(function () {
            d()
...
function OptimizeIndexDialogCtrl(a, b, c) {
    a.index = c, a.optimizedIndex = {maxSegments: c.numberOfSegments}, a.close = function (c) {
        b.close(a.optimizedIndex)
    }
}
function RestoreSnapshotCtrl(a, b, c) {
    a.snapshot = c, a.dialog = {}, a.close = function (c) {
        c.snapshot = a.snapshot.name, c.repository = a.snapshot.repository, b.close(c)
    }
}
function SnapshotCtrl(a, b, c, d) {
    a.repositories = [], a.snapshots = [], a.selectedRepository = "", a.$watch("selectedRepository", function () {
        a.listSnapshots()
    }), a.initRepositories = function () {
        c.loadRepositories(function (b) {
            a.repositories = b
        })
    }, a.selectRepository = function (b) {
        a.selectedRepository = b.name
    }, a.deleteRepository = function (b) {
        c.deleteRepository(b.name, function () {
            a.selectedRepository === name && (a.selectedRepository = ""), a.initRepositories()
        })
    }, a.listSnapshots = function () {
        "" !== a.selectedRepository && c.loadSnapshots(a.selectedRepository, function (b, c) {
            a.running = b, a.snapshots = c
        })
    }, a.createNewRepositoryDialog = function () {
        var d = {
            backdrop: !0,
            keyboard: !0,
            backdropClick: !0,
        ...
        e.result.then(function (b) {
            b && c.createRepository(b, function () {
                a.initRepositories(), a.selectedRepository = ""
            })
        }, function () {
        })
    }, a.removeSnapshot = function (b) {
        c.removeSnapshot(a.selectedRepository, b, function () {
            a.listSnapshots()
        })
    }, a.removeSnapshotFromRepository = function (b, d) {
        c.removeSnapshot(b, d, function () {
            a.listSnapshots()
        })
    }, a.createNewSnapshotDialog = function () {
        var d = {
            backdrop: !0,
            keyboard: !0,
            backdropClick: !0,
        ...
        e.result.then(function (b) {
            b && (b.repository = a.selectedRepository, c.createSnapshot(b, function () {
                a.listSnapshots()
            }))
        }, function () {
        })
    }, a.openRestoreSnapshotDialog = function (d) {
        var e = {
            backdrop: !0,
            keyboard: !0,
            backdropClick: !0,
        ...
        f.result.then(function (b) {
            b && c.restoreSnapshot(b, function () {
                a.listSnapshots()
            })
        }, function () {
        })
...
!function (a, b, c) {
    ...
    function f(a, b, c) {
        var d;
        if (a)if (x(a))for (d in a)"prototype" == d || "length" == d || "name" == d || a.hasOwnProperty && !a.hasOwnProperty(d) || b.call(c, a[d], d); else if (Ec(a) || e(a))for (d = 0; d < a.length; d++)b.call(c, a[d], d); else if (a.forEach && a.forEach !== f)a.forEach(b, c); else for (d in a)a.hasOwnProperty(d) && b.call(c, a[d], d);
        return a
    }
    ...
    function ha(b) {
        ...
        wc("ng", ["ngLocale"], ["$provide", function (a) {
            a.provider({$$sanitizeUri: Eb}), a.provider("$compile", Oa).directive({
                a: Fd,
                input: Qd,
                textarea: Qd,
                form: Jd,
                ...
                ngRequired: Yd,
                ngValue: _d
            }).directive({ngInclude: me}).directive(Gd).directive(ie), a.provider({
                $anchorScroll: Ia,
                $animate: cd,
                $browser: La,
                $cacheFactory: Ma,
    ...
    function ka(a, b, c, d) {
        function e(a) {
            ...
            if (!d || null != a)for (; m.length;)for (e = m.shift(), g = 0, h = e.length; h > g; g++)for (i = uc(e[g]), n ? i.triggerHandler("$destroy") : n = !n, j = 0, k = (l = i.children()).length; k > j; j++)m.push(vc(l[j]));
    ...
    function ma(a, b) {
        ...
        if (la(a))j.push(b.createTextNode(a)); else {
    ...
    function ra(a, b, c, d) {
        ...
        var e = ta(a, "events"), g = ta(a, "handle");
    ...
    function ta(a, b, c) {
        var d = a.ng339, e = Jc[d || -1];
        return s(c) ? (e || (a.ng339 = d = ia(), e = Jc[d] = {}), void(e[b] = c)) : e && e[b]
    }

    function ua(a, b, c) {
        var d = ta(a, "data"), e = s(c), f = !e && s(b), g = f && !t(b);
        if (d || g || ta(a, "data", d = {}), e)d[b] = c; else {
            if (!f)return d;
            if (g)return d && d[b];
            l(d, b)
        }
    ...
    function Aa(a, b, d) {
        ...
        for (var e = Ec(b) ? b : [b]; a;) {
            for (var f = 0, g = e.length; g > f; f++)if ((d = uc.data(a, e[f])) !== c)return d;
    ...
    function Ha(a) {
        ...
        function k(a) {
            ...
            return f(a, function (a) {
                if (!r.get(a)) {
                    r.put(a, !0);
                    try {
                        if (u(a))for (b = wc(a), g = g.concat(k(b.requires)).concat(b._runBlocks), c = b._invokeQueue, d = 0, e = c.length; e > d; d++) {
        ...
        function l(a, b) {
            ...
            return {
                invoke: d, instantiate: e, get: c, annotate: Ga, has: function (b) {
                    return s.hasOwnProperty(b + n) || a.hasOwnProperty(b)
                }
            }
        }

        var m = {}, n = "Provider", p = [], r = new Fa([], !0), s = {
            $provide: {
                provider: b(c),
                factory: b(d),
                service: b(e),
            ...
            function E(a, b, c, d, e) {
                ...
                switch (i) {
                    case 1:
                        ...
                        if (g = a.className, u(g) && "" !== g)for (; f = j.exec(g);)n = Pa(f[2]), J(b, n, "C", d, e) && (c[n] = Fc(f[3])), g = g.substr(f.index + f[0].length);
                        break;
                    case 3:
                        R(b, a.nodeValue);
                        break;
            ...
            function H(a, e, g, h, j, k, l, m, n) {
                ...
                function p(a, b, c, d) {
                    ...
                    if (u(b)) {
                        ...
                        if (e = null, d && "data" === g && (e = d[b]), e = e || c[g]("$" + b + "Controller"),
                            !e && !h)throw dd("ctreq", "Controller '{0}', required by directive '{1}', can't be found!", b, a);
                        return e
                    }
                ...
                for (var v, w, y, z, C, D, H = -Number.MAX_VALUE, J = n.controllerDirectives, P = n.newIsolateScopeDirective, R = n.templateDirective, S = n.nonTlbTranscludeDirective, U = !1, Y = !1, Z = n.hasElementTranscludeDirective, _ = g.$$element = uc(e), aa = k, ba = h, ca = 0, da = a.length; da > ca; ca++) {
                    ...
                    if ((D = w.scope) && (v = v || w, w.templateUrl || (Q("new/isolated scope", P, w, _), t(D) && (P = w))), y = w.name, !w.templateUrl && w.controller && (D = w.controller, J = J || {}, Q("'" + y + "' controller", J[y], w, _), J[y] = w), (D = w.transclude) && (U = !0, w.$$tlb || (Q("transclusion", S, w, _), S = w), "element" == D ? (Z = !0, H = w.priority, z = _, _ = g.$$element = uc(b.createComment(" " + y + ": " + g[y] + " ")), e = _[0], V(j, N(z), e), ba = A(z, h, H, aa && aa.name, {nonTlbTranscludeDirective: S})) : (z = uc(pa(e)).contents(), _.empty(), ba = A(z, h))), w.template)if (Y = !0, Q("template", R, w, _), R = w, D = x(w.template) ? w.template(_, g) : w.template, D = $(D), w.replace) {
                        ...
                        V(j, _, e);
                        var ga = {$attr: {}}, ha = E(e, [], ga), ia = a.splice(ca + 1, a.length - (ca + 1));
                    ...
                    }), da = a.length; else if (w.compile)try {
    ...
    function Ya() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, d, e, k, m) {
            function n(a) {
                function b(a) {
                    var b = l({}, a, {data: Wa(a.data, a.headers, e.transformResponse)});
                ...
                function d(a) {
                    ...
                    a:for (c in h) {
                        d = oc(c);
                        for (e in i)if (oc(e) === d)continue a;
                        i[c] = h[c]
                    }
                    return b(i), i
                }
    ...
    function lb(a, b) {
        ...
        eb(a, this, a), this.$$parse = function (d) {
            ...
            var f = gb(a, d) || gb(c, d), g = "#" == f.charAt(0) ? gb(b, f) : this.$$html5 ? f : "";
        ...
        this.hashPrefix = function (a) {
            ...
            g.on("click", function (b) {
                if (!b.ctrlKey && !b.metaKey && 2 != b.which) {
                    for (var c = uc(b.target); "a" !== oc(c[0].nodeName);)if (c[0] === g[0] || !(c = c.parent())[0])return;
    ...
    function wb(a, b, d, e, f, g, h) {
        ...
        var i = function (a) {
            return sb(a, g)
        }, j = h.expensiveChecks, k = j || vb(a) ? i : p, l = j || vb(b) ? i : p, m = j || vb(d) ? i : p, n = j || vb(e) ? i : p, o = j || vb(f) ? i : p;
    ...
    function yb(a, b, d) {
        var e = b.expensiveChecks, g = e ? ud : td;
        ...
        if (b.csp)h = 6 > j ? wb(i[0], i[1], i[2], i[3], i[4], d, b) : function (a, e) {
            ...
            f(i, function (a, c) {
                rb(a, d);
                var f = (c ? "s" : '((l&&l.hasOwnProperty("' + a + '"))?l:s)') + '["' + a + '"]', g = e || vb(a);
            ...
            return jd = function (a) {
                ...
                switch (typeof e) {
                    case"string":
                        ...
                        var j = f ? g : c, k = new rd(j), l = new sd(k, d, j);
            ...
            k.prototype = {
                constructor: k, $new: function (a) {
                    ...
                    for (var c, d, e, f = this, h = f, i = f, j = {
                        ...
                        for (j.currentScope = h, c = h.$$listeners[a] || [], d = 0, e = c.length; e > d; d++)if (c[d])try {
                            c[d].apply(null, k)
                        } catch (l) {
                            g(l)
                        } else c.splice(d, 1), d--, e--;
                        if (!(i = h.$$listenerCount[a] && h.$$childHead || h !== f && h.$$nextSibling))for (; h !== f && !(i = h.$$nextSibling);)h = h.$parent
                    }
                    return j
                }
            };
    ...
    function Kb() {
        this.$get = ["$window", "$document", function (a, b) {
            var c, d, e = {}, f = m((/android (\d+)/.exec(oc((a.navigator || {}).userAgent)) || [])[1]), g = /Boxee/i.test((a.navigator || {}).userAgent), h = b[0] || {}, i = h.documentMode, j = /^(Moz|webkit|O|ms)(?=[A-Z])/, k = h.body && h.body.style, l = !1, n = !1;
            if (k) {
        ...
        return function (a, b, c) {
            ...
            e.check = function (a) {
                ...
                if (a && b && "object" == typeof a && "object" == typeof b) {
                    for (var d in a)if ("$" !== d.charAt(0) && pc.call(a, d) && c(a[d], b[d]))return !0;
                    return !1
                }
    ...
    function cc(a, b, c, d) {
        ...
        var g = this, h = a.parent().controller("form") || Hd, i = 0, j = g.$error = {}, k = [];
    ...
    function gc(a, b, c, e, f, g) {
        var h = b.prop(nc), i = b[0].placeholder, j = {}, k = oc(b[0].type);
    ...
    var tc, uc, vc, wc, xc, yc = [].slice, zc = [].push, Ac = Object.prototype.toString, Bc = d("ng"), Cc = a.angular || (a.angular = {}), Dc = ["0", "0", "0"];
    ...
    }, Hc = /[A-Z]/g, Ic = {full: "1.2.28", major: 1, minor: 2, dot: 28, codeName: "finnish-disembarkation"};
    oa.expando = "ng339";
    var Jc = oa.cache = {}, Kc = 1, Lc = a.document.addEventListener ? function (a, b, c) {
    ...
    }, /([\:\-\_]+(.))/g), Oc = /^moz([A-Z])/, Pc = d("jqLite"), Qc = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Rc = /<|&#?\w+;/, Sc = /<([\w:]+)/, Tc = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Uc = {
    ...
    var Vc = oa.prototype = {
        ...
        }, length: 0, push: zc, sort: [].sort, splice: [].splice
    }, Wc = {};
    ...
    f("input,select,option,textarea,button,form,details".split(","), function (a) {
        Xc[qc(a)] = !0
    }), f({data: ua, removeData: sa}, function (a, b) {
        oa[b] = a
    }), f({
        data: ua, inheritedData: Aa, scope: function (a) {
        ...
        }, controller: za, injector: function (a) {
            return Aa(a, "$injector")
        }, removeAttr: function (a, b) {
            a.removeAttribute(b)
        }, hasClass: va, css: function (a, b, d) {
            if (b = ja(b), !s(d)) {
                var e;
        ...
        oa.prototype[b] = function (b, d) {
            ...
            if (a !== Ba && (2 == a.length && a !== va && a !== za ? b : d) === c) {
                if (t(b)) {
                    for (e = 0; g > e; e++)if (a === ua)a(this[e], b); else for (f in b)a(this[e], f, b[f]);
                    return this
                }
        ...
        }, addClass: xa, removeClass: wa, toggleClass: function (a, b, c) {
        ...
        }, clone: pa, triggerHandler: function (a, b, c) {
            var d, e, g, h = b.type || b, i = (ta(a, "events") || {})[h];
            i && (d = {
                preventDefault: function () {
    ...
    var Yc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Zc = /,/, $c = /^\s*(_?)(\S+?)\1\s*$/, _c = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, ad = d("$injector"), bd = d("$animate"), cd = ["$provide", function (a) {
    ...
    var ed = /^(x[\:\-_]|data[\:\-_])/i, fd = d("$interpolate"), gd = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, hd = {
        http: 80,
        https: 443,
        ftp: 21
    }, id = d("$location");
    ...
    var jd, kd = d("$parse"), ld = {}, md = Function.prototype.call, nd = Function.prototype.apply, od = Function.prototype.bind, pd = {
        "null": function () {
            return null
        }, "true": function () {
            return !0
    ...
    }, qd = {n: "\n", f: "\f", r: "\r", t: "	", v: "", "'": "'", '"': '"'}, rd = function (a) {
        this.options = a
    };
    rd.prototype = {
        constructor: rd, lex: function (a) {
            for (this.text = a, this.index = 0, this.ch = c, this.lastCh = ":", this.tokens = []; this.index < this.text.length;) {
                if (this.ch = this.text.charAt(this.index), this.is("\"'"))this.readString(this.ch); else if (this.isNumber(this.ch) || this.is(".") && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(this.ch))this.readIdent(); else if (this.is("(){}[].,;:?"))this.tokens.push({
                    ...
                    var b = this.ch + this.peek(), d = b + this.peek(2), e = pd[this.ch], f = pd[b], g = pd[d];
                    g ? (this.tokens.push({
                        index: this.index,
                        text: d,
                        fn: g
            ...
            if (pd.hasOwnProperty(f))h.fn = pd[f], h.literal = !0, h.constant = !0; else {
    ...
    sd.ZERO = l(function () {
        return 0
    }, {constant: !0}), sd.prototype = {
        constructor: sd, parse: function (a) {
            ...
            var b = this, c = this.expect().text, d = yb(c, this.options, this.text);
            ...
            return this.consume("]"), l(function (e, f) {
                ...
                assign: function (c, e, f) {
                    var g = rb(d(c, f), b.text), h = sb(a(c, f), b.text);
    ...
    var td = {}, ud = {}, vd = d("$sce"), wd = {
        HTML: "html",
        CSS: "css",
        URL: "url",
        RESOURCE_URL: "resourceUrl",
        JS: "js"
    }, xd = b.createElement("a"), yd = Mb(a.location.href, !0);
    ...
    var zd = ".", Ad = {
        ...
        a: Yb,
        Z: Xb
    }, Bd = /((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/, Cd = /^\-?\d+$/;
    Zb.$inject = ["$locale"];
    var Dd = q(oc), Ed = q(qc);
    ac.$inject = ["$parse"];
    var Fd = q({
    ...
    var Hd = {$addControl: o, $removeControl: o, $setValidity: o, $setDirty: o, $setPristine: o};
    ...
    var Id = function (a) {
    ...
    }, Jd = Id(), Kd = Id(!0), Ld = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Md = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Nd = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Od = {
        text: gc,
        number: hc,
        url: ic,
        email: jc,
        ...
        reset: o,
        file: o
    }, Pd = ["badInput"], Qd = ["$browser", "$sniffer", function (a, b) {
        return {
            restrict: "E", require: "?ngModel", link: function (c, d, e, f) {
                f && (Od[oc(e.type)] || Od.text)(c, d, e, f, b, a)
            }
        }
    }], Rd = "ng-valid", Sd = "ng-invalid", Td = "ng-pristine", Ud = "ng-dirty", Vd = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", function (a, b, c, e, g, h) {
        function i(a, b) {
        ...
        var l = e.inheritedData("$formController") || Hd, m = 0, n = this.$error = {};
        ...
        return {
            require: ["ngModel", "^?form"], controller: Vd, link: function (a, b, c, d) {
                var e = d[0], f = d[1] || Hd;
    ...
    }], de = mc("", !0), ee = mc("Odd", 0), fe = mc("Even", 1), ge = bc({
    ...
    var ke = ["$animate", function (a) {
    ...
    }), oe = bc({terminal: !0, priority: 1e3}), pe = ["$locale", "$interpolate", function (a, b) {
        var c = /{}/g;
        return {
        ...
        return {
            transclude: "element", priority: 1e3, terminal: !0, $$tlb: !0, link: function (d, k, l, m, n) {
                var o, p, q, r, s, t, u, v, w, x = l.ngRepeat, y = x.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), z = {$id: Ea};
                ...
                d.$watchCollection(u, function (a) {
                    ...
                    for (p = C.length, m = H.length = C.length, l = 0; m > l; l++)if (u = a === C ? l : C[l], y = a[u], z = B(u, y, l), da(z, "`track by` id"), A.hasOwnProperty(z))D = A[z], delete A[z], G[z] = D, H[l] = D; else {
    ...
    }], ze = d("ngOptions"), Ae = q({terminal: !0}), Be = ["$compile", "$parse", function (a, d) {
        ...
        return {
            ...
            link: function (h, i, j, k) {
                ...
                if (k[1]) {
                    for (var o, p = k[0], q = k[1], t = j.multiple, u = j.ngOptions, v = !1, w = uc(b.createElement("option")), x = uc(b.createElement("optgroup")), y = w.clone(), z = 0, A = i.children(), B = A.length; B > z; z++)if ("" === A[z].value) {
                        o = v = A.eq(z);
                        break
                    }
    ...
    return {
        restrict: "EA", controller: "AccordionController",
    ...
    this.options = function (a) {
        ...
        return function (e, l, m) {
            ...
            return {
                restrict: "EA", scope: !0, compile: function (a, b) {
                    var c = f(s);
    ...
    return {
        restrict: "EA", replace: !0, scope: {
            title: "@", content: "@",
            placement: "@", animation: "&", isOpen: "&"
...
myApp.config(["$routeProvider", function (a) {
    ...
    }), a.when("/about", {templateUrl: "/assets/partials/about.html"}), a.otherwise({redirectTo: "/dashboard"})
}]), myApp.factory("$exceptionHandler", ["$injector", "$log", function (a, b) {
    return function (c, d) {
        b.error(c);
        var e = a.get("errorHandling");
        throw e.add(c.message), c
    }
}]);
var serviceModule = angular.module("myApp.services", []);
CopyIndexDialogCtrl.$inject = ["$scope", "$modalInstance", "FileUploader", "index"], CreateNewIndexDialogCtrl.$inject = ["$scope", "$modalInstance", "FileUploader"], CreateSnapshotCtrl.$inject = ["$scope", "$modalInstance"], CreateSnapshotRepositoryCtrl.$inject = ["$scope", "$modalInstance"], DashboardCtrl.$inject = ["$scope"], DeleteIndexesDialogCtrl.$inject = ["$scope", "$modalInstance"], EditIndexDialogCtrl.$inject = ["$scope", "$modalInstance", "index"], IndexCtrl.$inject = ["$scope", "$modal", "indexService", "$rootScope"], NavbarCtrl.$inject = ["$scope", "$http", "$interval"], NotificationCtrl.$inject = ["$scope", "$timeout"], OptimizeIndexDialogCtrl.$inject = ["$scope", "$modalInstance", "index"], RestoreSnapshotCtrl.$inject = ["$scope", "$modalInstance", "snapshot"], SnapshotCtrl.$inject = ["$scope", "$modal", "snapshotService", "$rootScope"], angular.module("myApp.directives.confirm", []).directive("ngConfirmClick", [function () {
    return {
        link: function (a, b, c) {
    ...
    return new b(a)
}]), serviceModule.factory("indexService", ["$http", "$filter", "$log", "$rootScope", function (a, b, c, d) {
    function e(a, b, c) {
        this.loadIndices = function (c) {
            a.get("/index").success(function (a) {
                c(b("orderBy")(a, "name"))
            }).error(e)
        }, this.changeIndex = function (b, d) {
            a.post("/index/" + b.name, b).success(function (a) {
                c.info("changed the index " + b.name), d()
            }).error(e)
        }, this.deleteIndex = function (b, d) {
            a["delete"]("/index/" + b).success(function (a) {
                c.info("deleted the index " + b), d()
            }).error(e)
        }, this.closeIndex = function (b, d) {
            a.post("/index/" + b + "/close").success(function (a) {
                c.info("closed the index " + b), d()
            }).error(e)
        }, this.openIndex = function (b, d) {
            a.post("/index/" + b + "/open").success(function (a) {
                c.info("opened the index " + b), d()
            }).error(e)
        }, this.optimizeIndex = function (b, d, f) {
            a.post("/index/" + b + "/optimize?max=" + d).success(function (a) {
                c.info("optimized the index " + b), f()
            }).error(e)
        }, this.copyIndex = function (b, d) {
            a.post("/index/copy", b).success(function (a) {
                c.info("copied to the index " + b.name), d()
            }).error(e)
        }, this.createAlias = function (b, d) {
            a.post("/index/" + b + "/createalias").success(function (a) {
                c.info("alias created for the index " + b), d()
            }).error(e)
        };
        var e = function (a) {
            var b;
            b = a.errors && a.errors.length > 0 ? a.errors[0] : "Error without a message was thrown", c.error(b), d.$broadcast("msg:notification", "danger", b)
        }
    }

    return new e(a, b, c, d)
}]), serviceModule.factory("snapshotService", ["$http", "$filter", "$log", "$rootScope", function (a, b, c, d) {
    function e(a, b, c) {
        this.loadRepositories = function (c) {
            a.get("/repository").success(function (a) {
                c(b("orderBy")(a, "name"))
            }).error(e)
        }, this.loadSnapshots = function (c, d) {
            a.get("/repository/" + c + "/snapshots").success(function (a) {
                a.runningSnapshot ? d(!0, b("orderBy")(a.snapshotStatussus, "repository")) : d(!1, b("orderBy")(a.snapshots, "name"))
            }).error(e)
        }, this.deleteRepository = function (b, c) {
            a["delete"]("/repository/" + b).success(function (a) {
                c()
            }).error(e)
        }, this.createRepository = function (b, c) {
            a.post("/repository", b).success(function (a) {
                c()
            }).error(e)
        }, this.removeSnapshot = function (b, c, d) {
            a["delete"]("/repository/" + b + "/snapshot/" + c).success(function (a) {
                d()
            }).error(e)
        }, this.createSnapshot = function (b, c) {
            a.post("/repository/" + b.repository + "/snapshot", b).success(function (a) {
                c()
            }).error(e)
        }, this.restoreSnapshot = function (b, c) {
            a.post("/repository/" + b.repository + "/snapshot/" + b.snapshot, b).success(function (a) {
                c()
            }).error(e)
        };
        var e = function (a) {
...
//# sourceMappingURL=dwes.min.js.map